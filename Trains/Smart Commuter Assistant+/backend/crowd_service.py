...
class CrowdService:
    ...
    def check_consensus(
        self, stop_id: str, occupancy_level: int, user_id: str
    ) -> Tuple[bool, str]:
        ...
        try:
            ...
            corroborating = [
                ...
                if abs(int(r["occupancy_level"]) - occupancy_level) <= 1
            ]
            if corroborating:
                return True, "corroborated"
            return True, "accepted_no_consensus"
        except Exception:
    ...
    def submit_report(
        ...
        consensus_ok, consensus_note = self.check_consensus(
            stop_id, occupancy_level, user_id
        )
        ...
        try:
            ...
            elif consensus_note == "accepted_no_consensus":
                message = "Report submitted."
