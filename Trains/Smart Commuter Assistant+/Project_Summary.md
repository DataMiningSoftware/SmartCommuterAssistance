...
Python scripts under `lib/PythonScript/` do four main jobs:
...
The operational Python prediction script is `lib/PythonScript/predict_and_upsert_crowd.py`.
...
- `lib/PythonScript/crowd_predictor.pkl`
...
The training script is `lib/PythonScript/train_crowd_model.py`.
...
The hourly forecast generator is `lib/PythonScript/build_and_upsert_hourly_forecast.py`.
...
- `lib/PythonScript/manual_supabase_setup.sql`
...
- `lib/PythonScript/crowd_feature_utils.py`
- `lib/PythonScript/generate_crowd_data.py`
- `lib/PythonScript/generate_crowd_data_from_trends.py`
- `lib/PythonScript/train_crowd_model.py`
- `lib/PythonScript/predict_and_upsert_crowd.py`
- `lib/PythonScript/build_and_upsert_hourly_forecast.py`
- `lib/PythonScript/manual_supabase_setup.sql`
- `backend/main.py`
- `docker-compose.yml`
- `docker/python-worker/Dockerfile`
