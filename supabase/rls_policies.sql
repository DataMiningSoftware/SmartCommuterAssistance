...
DO $$ BEGIN
  -- 0. crowd_reports — time-series log of user submissions
  ...
  -- 1. historical_crowds — public read, system-only write
  ...
  -- 2. crowd_forecast_hourly — public read-only
  ...
  -- 3. profiles — users can read/update their own profile
  ...
  -- 4. user_preferences — users can manage their own preferences
  ...
  -- 5. favorite_routes — users can manage their own favorites
