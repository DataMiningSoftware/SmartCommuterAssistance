...
class OperatingHoursService {
  ...
  static final Map<String, _Hours> _lineHours = {
    'KJ': const _Hours(6 * 3600, 23 * 3600 + 30 * 60),
    'MRT': const _Hours(6 * 3600, 23 * 3600 + 30 * 60),
    'PYL': const _Hours(6 * 3600, 23 * 3600 + 30 * 60),
    'AG': const _Hours(6 * 3600, 23 * 3600 + 30 * 60),
    'PH': const _Hours(6 * 3600, 23 * 3600 + 30 * 60),
    'MR': const _Hours(6 * 3600, 23 * 3600 + 30 * 60),
    'BRT': const _Hours(6 * 3600, 23 * 3600),
    'KT1': const _Hours(6 * 3600, 23 * 3600),
    'KT2': const _Hours(6 * 3600, 23 * 3600),
    'ER6': const _Hours(6 * 3600, 24 * 3600),
    'ER7': const _Hours(6 * 3600, 24 * 3600),
    'KS': const _Hours(6 * 3600, 22 * 3600),
  };
